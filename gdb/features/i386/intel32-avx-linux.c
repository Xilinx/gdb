/* THIS FILE IS GENERATED.  Original: intel32-avx-linux.xml */

#include "defs.h"
#include "osabi.h"
#include "target-descriptions.h"

struct target_desc *tdesc_intel32_avx_linux;
static void
initialize_tdesc_intel32_avx_linux (void)
{
  ...
  tdesc_intel32_avx_linux = result;
}
